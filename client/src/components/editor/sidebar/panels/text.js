    ...
    <div className="h-full overflow-y-auto">
      <div className="p-4 space-y-4">
        ...
        >
          ...
          <span className="font-medium cursor-pointer">Add a text box</span>
        </Button>
        <div className="pt-2">
          ...
          <div className="space-y-4">
            {textPresets.map((preset, index) => (
              <button
                className="w-full text-left p-3 bg-white border border-gray-200 rounded-md hover:bg-gray-50 transition-colors cursor-pointer"
                key={index}
