    ...
    <div className="bg-white rounded-2xl shadow-xl p-8 w-full max-w-md mx-4 transition-all duration-300">
      <div className="space-y-8">
        ...
        <div className="flex flex-col gap-3">
          <Button
            variant={"outline"}
            className={`w-full flex items-center cursor-pointer justify-center gap-3 py-6 text-gray-700 border-gray-300 
          ...
          >
            ...
            <span className="font-medium">Login with Orchid</span>
          </Button>
